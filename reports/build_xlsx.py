...
KPI_L = [
    ...
    ('세금계산서 총액', 931288075, MONEY_W, '건당 435,385원 (÷2,139)'),
...
notes(ws, r, [
    ...
    '[금액 기준] 세금계산서 총액 931,288,075원(건당 435,385원)이 정답 기준이다. 크리에이터 원고료 527,612,205원(건당 246,663원)은 마크업·VAT 제외값이므로 단가로 쓰지 않는다.',
...
for nm, a, b, memo, f in [
    ...
    ('세금계산서 총액 (원)', None, 931288075, '발행분 기준 · 원고료 + 마크업 + VAT + 솔루션 + 지급대행', MONEY_W),
    ('  건당 단가 (원)', None, 435385, '931,288,075 ÷ 2,139건', MONEY_W),
    ('  참고: 크리에이터 원고료 (원)', None, 527612205, 'IMD 488,708,205 + JP 8,904,000 + US 30,000,000 · 건당 246,663원', MONEY_W),
]:
