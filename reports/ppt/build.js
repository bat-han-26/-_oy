...
const TAGTXT = '수량 2,139건 · 조회수 데이터 2,050건 (IMD 26.09.04)';
...
[
 { label:'평균 원고료', value:'23.8만원', main:'488,708,205원 ÷ 2,050건',
   note:'※ 참고 : 중위 25만원 (최다 25만원 1,167건)\n마크업·VAT 포함 광고주 단가 약 32만원\nUGC 협업 최다 아이디얼포맨 737건' },
 { label:'1만뷰 이상', value:'36.2%', main:'743건 / 2,050건',
   note:'※ 참고 : 조회수 분포\n1) 50만뷰 이상 : 6건\n2) 10만뷰 이상 : 167건\n3) 5만뷰 이상 : 255건' },
 { label:'최대 조회수', value:'84.6만뷰', main:'브링그린 (26.02.10)',
   note:'※ 참고 : 50만뷰 이상 6건\n2위 바이오힐보 76.5만뷰\n(26.05.19)' },
 { label:'최저 CPV', value:'0.33원', main:'아이디얼포맨 (26.01.30)',
   note:'※ 참고 : 단일 콘텐츠 기준\n브랜드 평균 CPV 최저\n브링그린 4.27원' },
 { label:'평균 CPV', value:'9.4원', main:'OYPB 12개 브랜드',
...
[
 { label:'평균 CPE', value:'1,334원', main:'OYPB 12개 브랜드\n원고료 ÷ 총 참여 366,236',
   note:'※ 참고 : 브랜드 최고 참여율\n라운드어라운드 1.73%\nRFP 최고 아이디얼포맨 1.08%' },
...
heading(s, '최우수 성과를 한 눈에 보면 다음과 같습니다.',
        '조회수·ROAS·매출 분포 모수 = 조회수 데이터 보유 2,050건 · 글로벌 시딩은 전체 2,139건 기준');
const W3=(12.133-0.30*3)/4;
[
 ['히어로 콘텐츠', [['조회수','건수'],['50만 이상','6건'],['30만 이상','17건'],['10만 이상','167건'],['5만 이상','255건'],['1만 이상','743건'],['모 수','2,050건']]],
 ['ROAS 기준',   [['ROAS','건수'],['1,000% 이상','25건'],['800% 이상','49건'],['600% 이상','86건'],['500% 이상','118건'],['300% 이상','172건'],['모 수','2,050건']]],
 ['매출액 기준',  [['매출액','건수'],['5천만원 이상','2건'],['3천만원 이상','6건'],['1천만원 이상','42건'],['5백만원 이상','82건'],['1백만원 이상','185건'],['모 수','2,050건']]],
 ['글로벌 시딩',  [['국가','건수'],['국내','1,972건'],['일본','99건'],['미국','68건'],['',''],['',''],['총 합','2,139건']]],
].forEach((c,i)=> dist(s, 0.6+i*(W3+0.30), W3, c[0], c[1]));
s.addText('※ 글로벌 89건(미국 68 · 일본 26.09 21)은 조회수 데이터가 없어 분포 판정 불가 → 위 건수는 하한이며 데이터 확보 시 증가 · ROAS는 광고비 10만원 이상 집행 건(242건)에서만 카운트',
