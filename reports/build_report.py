...
r = note(ws, r, [
    ...
    '· 2025 계약 59,830,000원에 바이오힐보 US 30,000,000원이 포함되므로 국내 272건에 대응하는 금액은 29,830,000원(건당 109,669원)이 된다. 나노 단가(25만원)보다 낮아 272건 중 일부는 무상·재사용 건일 가능성이 있다 → A4 확인 항목.',
])
r += 1
...
GAPS = [
    ...
    (0, '2025 계약 국내 건당액', '59,830,000원에 US 30,000,000원이 포함되므로 국내 272건 대응액은 29,830,000원(건당 109,669원). 나노 단가 25만원보다 낮아 272건 중 무상·재사용 건 포함 여부 확인 필요', 29830000, '높음'),
