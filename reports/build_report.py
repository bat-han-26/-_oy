...
for nm, q, a, vw, mth, memo in [
    ...
    ('미국 (US)', 68, INV_US, 4_739_117, '25.08', '25년 발행분 내 명시'),
]:
...
note(ws, r, [
    ...
    '· 바이오힐보 US 68건은 원고료 데이터가 없어 CPV를 산출하지 않았다. 청구 30,000,000원은 25년 발행분에 포함.',
])
ws.freeze_panes = 'B6'
...
YM = [
    ...
    ('25년 발행분', None, None, None, None, 59830000, '25.04~26.01 진행분 정산 · 발행월 미상 · US 30,000,000 포함'),
]
...
for a, b, c_, d in [
    ('세금계산서 발행 총액', f'{INV_TOT:,}원', '세금계산서 월별 확정 총액표(26.09.07) 840,514,264 + 2025 정산표 59,830,000', '2025 발행분에 바이오힐보 US 30,000,000 포함'),
...
for a, b, c_, d in [
    ...
    ('바이오힐보 US 원고료', 'IMD에 원고료 기재가 없다. 청구 30,000,000원만 확인된다',
     'US 68건의 원고료 기준 CPV 산출 불가', '청구액은 25년 발행분에 포함해 총액에만 반영'),
