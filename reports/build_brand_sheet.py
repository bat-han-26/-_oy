...
BD=[
 ('아이디얼포맨',737,0,17330588,231083,328799970,33768439,102736712,
  '25년 4Q UGC 협업 첫 시작을 바탕으로 \n250%대 ROAS는 300% 이상으로 올라 섬'),
 ('브링그린',313,0,15535558,59372,116761853,124304394,729266288,
  '전체 퍼포먼스 광고비 44% 집행 · 전환 매출 49% 창출\nUGC&협력광고 중심 티트리 라인 스케일업 필요'),
 ('라운드어라운드',281,0,2413068,47169,108396562,133848,348140,'PR키트 진행 등 참여율 1위(1.95%)\n광고는 281건 중 1건만 집행'),
 ('바이오힐보 (국내)',195,0,5440064,29506,66746218,56333229,172219558,
  '퍼포먼스 광고 성과는 전량 국내에서 발생\n최대 조회수 764,503뷰'),
 ('바이오힐보 (해외·JP)',0,7,44255,156,4105157,0,0,
  '26.06 NAD 크림 나노 시딩 테스트\n원고료 건당 333,000 · 조회수·참여 모두 저조'),
 ('바이오힐보 (해외·US)',0,68,4739117,24134,30000000,0,0,
  '68건 중 36건 성과 확보 · 건당 131,642뷰(국내의 4.7배)\n최대 2,954,129뷰 = 전체 1위'),
 ('식물나라',140,0,2788821,25032,57218591,14985030,118255596,
  '빅&스몰웨이브의 시작(25.05)\n마이크로 IMC 성과 가장 잘 워킹하는 브랜드'),
 ('웨이크메이크',70,60,3143931,19540,71765393,16409851,113788050,
  '26.04 행사 및 올영픽 등 미존재로\nUGC 협업 수량 증대해도 좋을 것으로 판단'),
 ('루테카',124,0,1655285,14046,39625063,0,0,'퍼포먼스 광고 미집행\n(브랜드 fade out)'),
 ('컬러그램',71,32,2653321,14526,55792089,23514230,134432958,
  'IMD 26.09.07로 103건 확정(v8 77건 → +26)\n조회수 +68% · 광고비 3.1배 · 매출 2.2배 · ROAS 572% 5위'),
 ('케어플러스',32,0,188488,1839,6516122,0,0,
  '26.07 UGC 첫 협업 · 퍼포먼스 광고 미집행\n원고료 마이크로 5건×20만 + 나노 27건×10만'),
 ('필리밀리',27,0,1353401,2409,11095018,14086284,121998372,'전체 브랜드 중 ROAS 1위(866%)\n최저 CPA 1,121원'),
 ('올더베러',8,0,396952,3440,3522228,0,0,'퍼포먼스 광고 미집행'),
]
r0=8
...
for k,t in enumerate([
 '※ 비용 = 세금계산서 발행 확정 900,344,264원 (26.02~08 확정 840,514,264 + 25년 발행 59,830,000 · 바이오힐보 US 30,000,000 포함). + JP 미발행 8,715,000(21건×415,000) → 진행 기준 909,059,264원',
 ...
 '※ (참고) 크리에이터 원고료 494,201,000원 = 청구액의 54.9%. 국내는 IMD 기재값, JP 99건은 확정 단가(웨이크메이크·컬러그램 건당 415,000 / 바이오힐보 333,000) 기준이다. 위 단가 산정에는 사용하지 않았다.',
