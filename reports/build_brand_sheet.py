...
BD=[
 ('아이디얼포맨',737,0,17330588,231083,329997090,33768439,102736712,
  '25년 4Q UGC 협업 첫 시작을 바탕으로 \n250%대 ROAS는 300% 이상으로 올라 섬'),
 ('브링그린',313,0,15535558,59372,117186968,124304394,729266288,
  '11개 브랜드 전체 퍼포먼스 광고비 중 44% 집행 → UGC&협력광고 중심 티트리 라인 스케일업 필요'),
 ('라운드어라운드',281,0,2413068,47169,108791220,133848,348140,'PR키트 진행 등 참여율 1위(1.95%)'),
 ('바이오힐보 (국내)',195,0,5440064,29506,66989232,56333229,172219558,
  '퍼포먼스 광고 성과는 전량 국내에서 발생\n최대 조회수 764,503뷰'),
 ('바이오힐보 (해외·JP)',0,7,44255,148,2944636,0,0,
  '26.06 NAD 크림 나노 시딩 테스트\n조회수·참여 모두 저조'),
 ('바이오힐보 (해외·US)',0,68,4739117,24134,30000000,0,0,
  '68건 중 36건 성과 확보 · 건당 131,642뷰(국내의 4.7배)\n최대 2,954,129뷰 = 전체 1위'),
 ('식물나라',140,0,2788821,25032,57426917,14985030,118255596,
  '빅&스몰웨이브의 시작(25.05)\n마이크로 IMC 성과 가장 잘 워킹하는 브랜드'),
 ('웨이크메이크',70,60,3143931,19540,68676009,16409851,113788050,
  '26.04 행사 및 올영픽 등 미존재로\nUGC 협업 수량 증대해도 좋을 것으로 판단'),
 ('루테카',124,0,1655285,14046,39769333,0,0,'퍼포먼스 광고 미집행\n(브랜드 fade out)'),
 ('컬러그램',45,32,1583237,10780,57352548,7670607,61405809,
  '전체 브랜드 중 ROAS 2위(800% 이상)\n→ 협업 수량 증가 필요'),
 ('케어플러스',32,0,188488,1839,6539846,0,0,
  '26.07 UGC 첫 협업 · 퍼포먼스 광고 미집행\n원고료 마이크로 5건×20만 + 나노 27건×10만'),
 ('필리밀리',27,0,1353401,2409,11135413,14086284,121998372,'전체 브랜드 중 ROAS 1위\n최저 CPA 확보'),
 ('올더베러',8,0,396952,3440,3535052,0,0,'퍼포먼스 광고 미집행'),
]
r0=8
...
ws['B3']='※ 통계 : 25.04 ~ 26.09 · 국내외 전체 2,139건(글로벌 167건 = JP 99 + US 68) · 26.09.07 기준'
ws['B4']='※ RD : 표준 기준 ⑤ — 수량·비용 전체 2,139건 / 조회수·참여 성과 집계분 2,086건 · 모든 단가는 세금계산서 발행 비용 기준'
for k,t in enumerate([
 ...
 '※ 평균 CPV = 세금계산서 ÷ 조회수 / 평균 CPE = 세금계산서 ÷ 참여수 / 참여수 = 좋아요 + 댓글 → 소계 CPV 15.90원 · CPE 1,922원 · 건당 청구액 420,918원',
 '※ 참여수는 좋아요 데이터 공란 505건(IMD 2,050건의 24.6%)을 브랜드·국가별 좋아요율과 좋아요/댓글비의 중앙값으로 추정해 반영한 값이다 — 좋아요 실측 358,615 + 추정 78,128 = 436,743, 댓글 31,755(전량 실측)',
 '※ 미집계 53건(바이오힐보 US 32 + 웨이크메이크JP 26.09 21)은 조회수·참여 데이터가 없어 성과 분모에서 제외했다. 수량·비용에는 포함되어 있다.',
 '※ (참고) 크리에이터 원고료 492,408,205원 = 청구액의 54.7%. 마크업·VAT·솔루션·지급대행 제외 금액으로 위 단가 산정에는 사용하지 않았다.',
]):
